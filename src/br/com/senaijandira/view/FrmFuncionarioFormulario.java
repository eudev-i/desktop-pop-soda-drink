...
public class FrmFuncionarioFormulario extends JFrame {
	...
	public FrmFuncionarioFormulario(String modo, int idCargo, int idPerfil) {
		...
		if (modo.equals("NOVO")) {
			lbl_titulo.setText("NOVO FUNCION�RIO");
		}else if (modo.equals("EDITAR")) {
			lbl_titulo.setText("EDITAR FUNCION�RIO");
		}else if (modo.equals("EXCLUIR")) {
			lbl_titulo.setText("EXCLUIR FUNCION�RIO");
		}
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (modo.equals("NOVO")) {
					...
					int resposta = JOptionPane.showConfirmDialog(null,
							"Tem certeza que deseja excluir " + funcionario.getNome() + "?", "Aten��o",
