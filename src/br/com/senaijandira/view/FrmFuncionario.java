...
public class FrmFuncionario extends JFrame {
	...
	public FrmFuncionario() {
		...
		painel_tabela.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Funcion�rios", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLACK));
	...
	public void CriarTabela() 
	{
		...
		String[] nomeColunas = {"Matr�cula", "Nome", "E-mail", "Dt Admiss�o"};
